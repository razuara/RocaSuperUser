...
public class SexoEditarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sexo_editar);

        nombreEditText = findViewById(R.id.nombreEditText);
        actualizarButton = findViewById(R.id.actualizarButton);
        borrarButton = findViewById(R.id.borrarButton);

        String idSexo = getIntent().getStringExtra("idSexo");

        mDatabase = FirebaseDatabase.getInstance().getReference("sexo");

        mDatabase.child(idSexo).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void actualizar(String nombre)
    {
        ...
        mDatabase.child(idSexo).child("nombre").setValue(nombre);

        Intent intent = new Intent(SexoEditarActivity.this,SexoActivity.class);
    ...
    private void CreateAlertDialog() {
        ...
        dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                String idSexo = getIntent().getStringExtra("idSexo");
                mDatabase = FirebaseDatabase.getInstance().getReference("sexo").child(idSexo);
        ...
        dialog.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(SexoEditarActivity.this,"Proceso Cancelado",Toast.LENGTH_LONG).show();
            }
        });
        dialog.create();
        dialog.show();
